...
namespace Day1
{
    class Program
    {
        private const string inputTest = @"0,9 -> 5,9
8,0 -> 0,8
9,4 -> 3,4
2,2 -> 2,1
7,0 -> 7,4
...
5,5 -> 8,2";
        ...
        private const string input = @"432,708 -> 432,160
579,594 -> 579,448
351,791 -> 351,595
520,836 -> 564,880
30,443 -> 666,443
        ...
        public class Line
        {
            ...
            static void exo1()
            {
                ...
                var strings = input.Split("\r\n", StringSplitOptions.RemoveEmptyEntries).Select(s => s.Trim())
                    .ToArray();
                var lines = strings.Select(s => new Line(s)).Where(l => l.IsVerticalOrHorizontal()).ToArray();
